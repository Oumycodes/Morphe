...
import Svg, { Defs, ClipPath, Circle, Path, Line, Ellipse, Rect } from 'react-native-svg'
...
const s = StyleSheet.create({
  ...
  pageTitle: { fontSize: 28, fontWeight: '800', color: colors.ink, letterSpacing: -1, marginBottom: 16 },
  scoreBanner: {
    backgroundColor: colors.primaryTint, borderWidth: 0.5, borderColor: '#BFDBFE',
  ...
  scoreRing: {
    ...
    backgroundColor: colors.score.greenTint, borderWidth: 2.5,
    borderColor: colors.score.green, alignItems: 'center', justifyContent: 'center',
  },
